...
<img src="img\register.jpg" width="360" height="245">
	...
	<div class="row">
		<div class="container card form_container">
			<form method="get" id="register" class="signup-form" action="RegistrationServlet">
			  <div class="form-row">
			    ...
			    <div class="form-group col-md-6">
			      ...
			      <input type="tel" class="form-control" name="contact" id="contact" placeholder="XXXXXXXXXX" required>
			    </div>
			    <div class="form-group col-md-6">
			      <label for="inputDOB">Date of Birth</label>
			      <input type="date" class="form-control" name="dob" id="inputDOB" placeholder="31/12/99">
			    </div>
			  ...
			  <div class="form-group">
			    <div class="form-check">
			      <p>Already a user? Skip to <a class="login_ref" href="Login.jsp" id="checkuser">Login</a></p>
